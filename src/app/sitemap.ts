...
const staticPages: MetadataRoute.Sitemap =
  [
    ...
    {
      url: `${siteUrl}/master-final`,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/circuito`,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/circuito/faq`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/circuito/reglamento`,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/jugadores`,
      changeFrequency: "weekly",
      priority: 0.7,
    },
    {
