  ...
  return (
    <main className="max-w-2xl mx-auto px-5 py-12">
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        ...
        <div className="rounded-card bg-navy/5 p-5">
          <p className="text-navy/50 text-sm uppercase mb-1">Torneos jugados</p>
          <p className="font-display text-3xl text-navy">{torneosJugados}</p>
        </div>
      </div>
